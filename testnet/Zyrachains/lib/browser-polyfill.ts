export const BROWSER_POLYFILL = `/* Zyrachain legacy-browser polyfills (Safari < 15.4 / iOS < 15.4).
   Must stay ES5: this file runs raw at HTML parse time in old browsers,
   before any bundled script is parsed. */
(function () {
  ...
  if (typeof g['structuredClone'] !== 'function') {
    g['structuredClone'] = function (value) {
      ...
      var proto = (typeof Object.getPrototypeOf === 'function') ? Object.getPrototypeOf(value) : null;
      var copy = proto ? Object.create(proto) : {};
      for (var k in value) {
