...
UserActionSchema.index({ user_uid: 1, post_uid: 1, action_type: 1 }, { unique: true });
UserActionSchema.index({ post_uid: 1, action_type: 1 });
UserActionSchema.index({ user_uid: 1, createdAt: -1 });
exports.default = mongoose_1.default.models.UserAction || mongoose_1.default.model('UserAction', UserActionSchema);
