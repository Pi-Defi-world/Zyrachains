...
async function main() {
  await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/Zyrachain');
  ...
  // 4. Sum of core team wallet balances (by joining with core-team-addresses)
  ...
  // 7. Check the expected ~20B - any wallets with very large balances?
  ...
  // 8. Check if baselineSumPiCore matches the core balance sum
