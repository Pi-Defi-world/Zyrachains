...
function loadState(): AdCooldownState {
  if (typeof window === 'undefined') {
    return { lastRewardedTime: 0, dailyRewardedCount: 0, lastRewardedDate: getTodayKey() };
  }
  try {
...
export function AdCooldownProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AdCooldownContext.Provider value={{ canShowRewarded, recordRewardedShown, getRewardedCooldownMs }}>
      {children}
